...
const OVERVIEW_STATS = [
  ...
  { id: 'stages', label: 'Journey Stages', value: techThiralJourney.length },
  { id: 'highlights', label: 'Expo Highlights', value: techThiralHighlights.length },
  { id: 'audience', label: 'Exhibitor Categories', value: techThiralAudience.length },
];
    ...
    <div className="relative">
      ...
      <section className="relative overflow-hidden bg-navy-deep py-32 text-center sm:py-44">
        ...
        <div className="relative mx-auto flex max-w-4xl flex-col items-center gap-5 px-4 sm:px-6">
          <Breadcrumb items={[{ label: 'Home', path: '/' }, { label: 'Tech Thiral' }]} tone="dark" />
      ...
      <section className="relative overflow-hidden bg-cream/95 py-24">
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <SectionHeading eyebrow="About Tech Thiral" title="Where Industry Meets Innovation" />
          <motion.div
      ...
      <section className="relative overflow-hidden bg-navy py-24">
        ...
        <div className="relative mx-auto grid max-w-5xl grid-cols-1 gap-6 px-4 sm:grid-cols-2 sm:px-6 lg:px-8">
          {[
            { icon: Sparkles, title: 'Vision', text: 'To be the meeting point where students, industry, and startups discover each other and build what comes next.' },
            { icon: Rocket, title: 'Mission', text: 'To give startups and industry a platform to showcase innovation, and give students direct access to the ecosystem building it.' },
          ].map((item, index) => (
            <motion.div
              key={item.title}
              initial={{ opacity: 0, y: 24 }}
      ...
      <section className="relative bg-cream/95 py-24">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <SectionHeading eyebrow="What You'll Experience" title="Discover. Connect. Explore." />
      ...
      <section className="relative overflow-hidden bg-navy-deep py-24">
        <div className="absolute inset-0 bp-grid-bg opacity-20" />
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <SectionHeading eyebrow="Event Overview" title="Two Days. One Industry Floor." tone="dark" />
          <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-5">
            <p className="font-body text-base leading-relaxed text-beige/85">
              Tech Thiral is a two-day industry expo held in the Parking Space venue, running
              continuously across both days of Porikkalam alongside Thulira.
            </p>
            <p className="font-body text-base leading-relaxed text-beige/85">
              Startups, industry professionals, entrepreneurs, researchers, and innovators exhibit
              their technologies and ventures to a live audience of engineering students, faculty,
              and the GCT alumni community.
            </p>
            <p className="font-body text-base leading-relaxed text-beige/85">
              The expo promotes discovery, direct engagement with founders and experts, and
              long-term connections across the startup and industrial ecosystem.
            </p>
          </div>
      ...
      <section className="relative bg-cream/95 py-24">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          <SectionHeading eyebrow="Who Can Showcase" title="Built For The Ecosystem" />
          <p className="mx-auto mt-8 max-w-2xl font-body text-base leading-relaxed text-slate">
            Tech Thiral is open to organizations and individuals building at the edge of technology
            and enterprise.
          </p>
      ...
      <section className="relative overflow-hidden bg-navy py-24">
        ...
        <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <SectionHeading eyebrow="Expo Floor" title="What Exhibitors Get" tone="dark" />
          <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {techThiralExhibitionOpportunities.map((item, index) => (
              <motion.div
                ...
                className="flex items-center gap-3 border border-gold/20 bg-navy-deep/60 p-5"
              >
                <Award size={18} className="shrink-0 text-gold" />
                <span className="font-body text-sm text-beige/85">{item}</span>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="relative bg-cream/95 py-24">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <SectionHeading eyebrow="Get Involved" title="Showcase At Tech Thiral" />
          <motion.div
            initial={{ opacity: 0, y: 16 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, amount: 0.4 }}

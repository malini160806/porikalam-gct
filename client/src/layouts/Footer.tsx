      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 border-t border-gold/20 pt-10 sm:grid-cols-2">
          ...
          <div className="flex flex-col gap-3">
            <span className="font-heading text-sm uppercase tracking-wider text-gold">Newsletter</span>
        ...
        <div className="mt-10 flex flex-col items-center gap-2 border-t border-gold/15 pt-6 text-center font-body text-xs text-beige/60 sm:flex-row sm:justify-between">
          <span>&copy; {SITE.year} Porikkalam. All Rights Reserved.</span>
          <span>Designed with heritage &amp; precision by Team Porikkalam</span>
        </div>
      </div>
    </footer>
  );
...
function FooterColumn({
  ...
  return (
    <div className="flex flex-col gap-3">
      <span className="font-heading text-sm uppercase tracking-wider text-gold">{title}</span>

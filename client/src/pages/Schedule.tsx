...
function getIcon(item: ScheduleItem): IconType {
  if (
    ...
    return RELATED_ICONS[item.relatedEventId];
  }
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1.5">
        ...
        {/* FIRST LINE — LOCATION */}
        <span className="flex items-center gap-1.5 font-body text-xs font-semibold leading-relaxed text-beige/85 sm:text-sm">
          <MapPin
            size={12}
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      <div>
        ...
        {/* Location */}
        <span className="flex items-center gap-1.5 font-body text-sm font-semibold text-beige/85">
          <MapPin
            size={12}
            className="text-gold"
          />
